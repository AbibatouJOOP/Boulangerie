...
class PaiementController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            $validatedData = $request->validate([
                ...
                'montant_payé' => 'required|numeric|min:0',
    ...
    public function update(Request $request, $id)
    {
        try {
            $validatedData = $request->validate([
                'mode_paiement' => 'sometimes|in:en_ligne,à_la_livraison',
                'montant_payé' => 'sometimes|numeric|min:0',
                'date_paiement' => 'sometimes|date',
                'statut' => 'sometimes|in:payée,non_payée,en_cours,échec,annulé,remboursé_total,remboursé_partiel',
                'numero_telephone' => 'sometimes|nullable|string|max:20',
                'operateur' => 'sometimes|nullable|in:orange,mtn,moov',
                'reference_transaction' => 'sometimes|nullable|string|max:100'
            ]);
